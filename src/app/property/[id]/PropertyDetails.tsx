...
export default function PropertyDetails({ property, settings }: Props) {
  ...
  const whatsappMessage = encodeURIComponent(`Hello! I'm interested in: ${property.title}`);
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              {settings?.contact_email && (
                <a
                  href={`mailto:${settings.contact_email}?subject=Inquiry about: ${property.title}`}
