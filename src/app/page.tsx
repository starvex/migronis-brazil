      ...
      <section className="relative py-24 px-4 bg-gradient-to-b from-neutral-900 to-black">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-neutral-400 text-lg md:text-xl max-w-2xl mx-auto mb-8">
            Премиальные объекты в самом красивом регионе Бразилии.
            Инвестиции, жизнь у океана, ваш новый дом.
          </p>
          <a 
            href="#properties" 
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-neutral-400 text-sm">Объектов</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-blue-400">7</div>
              <div className="text-neutral-400 text-sm">Городов</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-neutral-400 text-sm">Юр. поддержка</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-black to-neutral-900">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-neutral-400 mb-8">
            Свяжитесь с нами для подбора идеального объекта под ваши цели —
            инвестиции, переезд или отдых.
          </p>
